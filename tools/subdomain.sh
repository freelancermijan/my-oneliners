...
if [[ "$1" == "-s" ]]; then
    ...
    mkdir -p bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains bug_bounty_report/$domain_Without_Protocol_save/recon/screenshot
    ...
    # subprober -f bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/unique_Subdomains.txt -sc -ra -tl -sv -wc -l -apt -dhp -ip -o bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/httpx_full_detail_subdomains.txt
    ...
    echo "=================================================================="
    echo ""
    httpx -l bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/200_live_subdomains.txt -mc 200 -system-chrome -ss -srd bug_bounty_report/$domain_Without_Protocol_save/recon/screenshot -t 160 -random-agent
...
if [[ "$1" == "-l" ]]; then
    ...
    echo "=================================================================="
    echo ""
    subdominator -d "$domain_Without_Protocol" -cp ~/.config/Subdominator/provider-config.yaml -o bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/subdominator.txt
    echo ""
    echo "=================================================================="
    ...
    cat bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/sublist3r.txt bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/subdominator.txt | sort -u | tee bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/unique_Subdomains.txt
    cat bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/unique_Subdomains.txt | wc -l
    echo ""
    echo "=================================================================="
    echo "==================== All domain collection Finished =============="
    ...
    # subprober -f bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/unique_Subdomains.txt -sc -ra -tl -sv -wc -l -apt -dhp -ip -c 30 -o bug_bounty_report/$domain_Without_Protocol_save/recon/subdomains/httpx_full_detail_subdomains.txt
